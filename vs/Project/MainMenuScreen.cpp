...
void Engine::MainMenuScreen::Init()
{
	...
	// Create Text
	textAbove = (new Text("SAIBA-45.ttf", 100, game->GetDefaultTextShader()))
		->SetText("Ghost of")->SetPosition(game->GetSettings()->screenWidth * 0.5f - 250, game->GetSettings()->screenHeight - 200.0f)->SetColor(255, 255, 255);
	textBelow = (new Text("SAIBA-45.ttf", 100, game->GetDefaultTextShader()))
		->SetText("AMBATRON")->SetPosition(game->GetSettings()->screenWidth * 0.5f - 275, game->GetSettings()->screenHeight - 350.0f)->SetColor(255, 255, 255);
